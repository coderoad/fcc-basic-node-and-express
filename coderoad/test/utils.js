...
// two directories up from root
const pathFromRoot = ["..", ".."];

const getPackageJson = async (dir = __dirname) => {
  // load package.json file
  const pathToPackageJson = join(dir, ...pathFromRoot, "package.json");
